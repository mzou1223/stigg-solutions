...
exports.GrantPromotionalEntitlementsGroupDocument = (0, graphql_tag_1.default) `
  ...
  grantPromotionalEntitlementsGroup(input: $input) {
    ...
    ${exports.PromotionalEntitlementFragmentDoc}`;
exports.RevokePromotionalEntitlementsGroupDocument = (0, graphql_tag_1.default) `
  ...
  revokePromotionalEntitlementsGroup(input: $input) {
    ...
    ${exports.PromotionalEntitlementFragmentDoc}`;
exports.UnlinkPromotionalEntitlementsGroupDocument = (0, graphql_tag_1.default) `
...
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        ...
        GrantPromotionalEntitlementsGroup(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.GrantPromotionalEntitlementsGroupDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'GrantPromotionalEntitlementsGroup', 'mutation');
        },
        RevokePromotionalEntitlementsGroup(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.RevokePromotionalEntitlementsGroupDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'RevokePromotionalEntitlementsGroup', 'mutation');
        },
        UnlinkPromotionalEntitlementsGroup(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.UnlinkPromotionalEntitlementsGroupDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'UnlinkPromotionalEntitlementsGroup', 'mutation');
        },
